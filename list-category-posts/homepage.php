...
while ( have_posts() ):
  ...
  $lcp_display_output .= '<div class="lcp_single">';

  //Post Thumbnail
  $lcp_display_output .= $this->get_thumbnail($post, 'lcp_thumbnail');

  $lcp_display_output .= '<div class="lcp_content">';
  ...
  //Show date:
  $lcp_display_output .= ' ' . $this->get_date($post, 'strong');
   ...
   */
  $lcp_display_output .= $this->get_excerpt($post, 'div', 'lcp_excerpt_home');
